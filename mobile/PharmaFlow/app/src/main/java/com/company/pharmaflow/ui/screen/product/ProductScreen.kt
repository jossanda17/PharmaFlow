...
import com.company.pharmaflow.ui.ProductTopAppBar
import com.company.pharmaflow.ui.item.formatedPrice
import com.company.pharmaflow.ui.navigation.NavigationDestination
...
fun ProductScreen(
    ...
    Scaffold(
        ...
        topBar = {
            ProductTopAppBar(
                title = stringResource(R.string.etalase),
        ...
        ProductBody(
            itemList = productUiState.itemList,
